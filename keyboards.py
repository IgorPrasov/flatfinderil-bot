...
def main_menu_keyboard(ctx):
    ...
    upload_label = {"ru": "📤 Загрузить CSV/XLSX", "en": "📤 Upload CSV/XLSX", "he": "📤 העלה CSV/XLSX"}.get(lang, "📤 Upload")
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton(t("btn_all_listings", ctx), callback_data="all_listings"), InlineKeyboardButton(upload_label, callback_data="upload_listings")],
        ...
        [InlineKeyboardButton(t("btn_cabinet", ctx), callback_data="cabinet"), InlineKeyboardButton(t("btn_help", ctx), callback_data="help")],
