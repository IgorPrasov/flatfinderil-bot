...
if _USE_PG:
    ...
    from database_pg import (          # explicit re-exports for type checkers
        ...
        get_all_favorites_bulk,
        update_favorite_price,
        add_review,
        get_reviews,
        get_all_reviews_bulk,
        get_average_rating,
        user_has_reviewed,
        add_referral,
        get_referral_count,
        get_all_referrals_bulk,
        add_bonus_days,
        get_bonus_days,
        ...
        get_all_bot_users,
        get_sources_stats,
        get_all_agent_profiles_bulk,
        get_all_service_profiles_bulk,
        get_all_user_listings_bulk,
        get_all_service_emails,
        _load,
        _init_db,
        _text_fingerprint,
        _migrate_sublet_deal_type,
        _cleanup_seeking_listings,
    )
