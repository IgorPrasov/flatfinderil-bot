...
OUT = "/Users/alinatsarenko/projects/flatfinderil-bot/FlatFinderIL.pdf"
...
class CoverPage(Flowable):
    ...
    def draw(self):
        ...
        c.setFillColor(TG)
        c.setFont(BASE_FONT, 14)
        c.drawString(30, self.h - 185, "@FlatFinderIL")
...
def build():
    ...
    story.append(Paragraph(
        "FlatFinderIL  |  Март 2026  |  Deployment: Railway  |  @FlatFinderIL",
        ST["center"]
    ))
