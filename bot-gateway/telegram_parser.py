...
def is_ad_or_spam(text):
    ...
    seeking_patterns = [
        ...
        r'срочно\s+ищу',
        r'срочно\s+ищем',
        r'мне\s+нужна\s+квартир',
        r'нам\s+нужна\s+(квартир|комнат)',
        # English seeking
        r'looking\s+for\s+(an?\s+)?(apart|flat|room|place)',
        r'searching\s+for\s+(an?\s+)?(apart|flat|room)',
        r'need\s+(an?\s+)?(apart|flat|room\s+to\s+rent)',
        r'want\s+to\s+rent',
        # Hebrew seeking
        r'מחפש[תים]?\s+דירה',
        r'מחפש[תים]?\s+חדר',
        r'מחפש[תים]?\s+שכירות',
        r'מחפשים\s+(דירה|חדר|להשכיר|להשכרה)',
        r'צריכ[האים]+\s+(דירה|חדר|שכירות)',
        r'לחפש\s+(דירה|חדר)',
